...
train1 = Train("DCC4",4) # Create the DCC controller with the RPi encoder, Create locos (args: Name, DCC Address) and Register locos on the controller
train2 = Train("DCC1",1)
...
train1.l.f2 = False
train1.stop() # Stop the controller
